...
state(['event_name', 'location', 'participant', 'time']);
...
$save = function(){
    ...
    session()->flash('success', 'Berhasil menambahkan Agenda');
...
<div>
    <h2 class="flex-1 mb-3 text-3xl font-semibold text-center uppercase md:mb-4">Tambah Agenda</h2>
